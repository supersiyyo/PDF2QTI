...
- **Tools**:
    ...
    - **Canvas Critter**: Encapsulated in `/student/canvas-critter`. A dedicated landing page for downloading the 100MB standalone Godot desktop application, complete with beta warnings and SiteGround-hosted binary links.
